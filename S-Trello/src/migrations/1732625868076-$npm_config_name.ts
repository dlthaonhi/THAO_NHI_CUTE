...
export class  $npmConfigName1732625868076 implements MigrationInterface {
    name = ' $npmConfigName1732625868076'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`cards\` CHANGE \`description\` \`description\` int NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE \`cards\` CHANGE \`position\` \`position\` int NULL DEFAULT '0'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`cards\` CHANGE \`position\` \`position\` int NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE \`cards\` CHANGE \`description\` \`description\` int NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE \`cards\` ADD CONSTRAINT \`FK_2cc808bbdb6f4e1169a8916d0a6\` FOREIGN KEY (\`listIDId\`) REFERENCES \`lists\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
